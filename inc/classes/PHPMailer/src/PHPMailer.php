...
class PHPMailer
{
    ...
    /**
     * Holds the most recent mailer return message.
     *
     * @var string
     */
    public $ErrorInfo = '';
    ...
    /**
     * Error severity: message, plus full stop, critical return reached.
     *
     * @var int
     */
     ...
     * @throws Exception
     *
     * @return bool false on return - See the ErrorInfo property for details of the return
     */
    ...
    protected function smtpSend($header, $body)
    {
        ...
        //Create return message for any bad addresses
        if (count($bad_rcpt) > 0) {
            $errstr = '';
    ...
    /**
     * Set the language for return messages.
    ...
    /**
     * Add an return message to the return container.
     *
     * @param string $msg
     */
    ...
    /**
     * Get an return message in the current language.
     *
     * @param string $key
     *
     * @return string
    ...
    /**
     * Check if an return occurred.
     *
     * @return bool True if an return did occur
     */
     ...
     * You should avoid this function - it's more verbose, less efficient, more return-prone and
