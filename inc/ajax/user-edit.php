...
try{
                        ...
                        <div class="bgc-white bd bdrs-3 p-20 mB-20">
                            ...
                            <form id="user_edit_form" action="/inc/ajax/user-add" method="POST"  class="needs-validation" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <label for="password"></label><input type="password" id="password" class="form-control" name="user_password" style="text-transform: " />
                                        <small> If You Dont Want To Change Password, Dont Edit This Input</small>
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <select id="setSchool" class="form-control school_country" name="user_school_id" required <?php echo $userData["school_id"] != "" ? "" : "disabled" ?>>
                                            <option value="">Please Select...</option>
                                            <?php
                                            ...
                                            while($data = $query->fetch(PDO::FETCH_ASSOC))
                                            {
                                                ...
                                                <option value="<?=$data["id"]?>" <?php echo $userData["school_id"] == $data["id"] ? "selected" :""?>><?=$data["school_name"]?></option>
                                    ...
                                    <div class="col-sm-4">
                                        <select id="setCountry" class="form-control school_country" name="user_represented_country_id" required <?php echo $userData["auth"] == ("4") ? "" : "disabled" ?>>
                                            ...
                                            for($i = 0; $i < count($country_array) ; $i++ ){
                                                ...
                                                ?>
                                                <option value="<?=$country_array[$i]["id"]?>" <?php echo $userData["country_id"] == $country_array[$i]["id"] ? "selected" :""?>><?=$country_array[$i]["country_name"]?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="col-sm-4">
                                        <select id="setCommittee" class="form-control school_country" name="user_committee_id" required <?php echo $userData["auth"] == "4" ? "" : "disabled" ?>>
                                            ...
                                            while($data = $query->fetch(PDO::FETCH_ASSOC))
                                            {
                                                ...
                                                <option value="<?=$data["id"]?>" <?php echo $userData["committee_id"] == $data["id"] ? "selected" :""?>><?=$data["committee_name"]?></option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <select  class="form-control" name="user_is_active" required>
                                            <option value="">Please Select...</option>
                                            <option value="1" <?php echo $userData["isactive"] == "1" ? "selected" : "" ?>>Yes</option>
                                            <option value="0" <?php echo $userData["isactive"] == "0" ? "selected" : "" ?>>No</option>
                                        </select>
                                ...
                                <input type="hidden" name="user_old_statue" value="<?=$userData["auth"]?>">
    ...
    <script>
        ...
        $("#user_edit_form").submit(function (e) {
            ...
            if(!$("#user_edit_form").hasClass("not-valid")){

                $.ajax({
                    type: "POST",
                    url: "/inc/ajax/user-edit-post",
                    data: $("#user_edit_form").serializeArray(),
                    beforeSend:function () {
                        show_loading(button);
                    },
                    error:function () {
