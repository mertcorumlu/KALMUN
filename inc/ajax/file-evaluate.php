        ...
        <div class="row">
            ...
            <div class="col-md-12" style="padding:0;">
                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                    <h4 class="c-grey-900 mT-10 mB-30">Evaluate File</h4>

                    <form id="file-commit-form" action="/inc/ajax/file-evaluate-post.php" method="POST" enctype="multipart/form-data"  class="needs-validation" >
                        ...
                        <fieldset>
                            ...
                            <input type="hidden" name="type" value="file_evaluate">
