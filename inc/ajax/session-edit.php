...
try{
    ...
    if($select_query->rowCount() < 1){
        echo '<div class="alert alert-danger" >No Such session!</div>';
        exit;
    }

    $sessionData = $select_query->fetch(PDO::FETCH_ASSOC);
    ...
    <div class="row" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="col-md-12" style="padding:0;">
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                <h4 class="c-grey-900 mT-10 mB-30">Edit Session</h4>

                <form id="session_edit_form" action="" method="POST"  class="needs-validation" >
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="session_name" style="text-transform: " placeholder="e.g. 06/03/2018 Session 1" value="<?=$sessionData["session_name"]?>" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="datetime-local" class="form-control" name="session_start" style="text-transform: " value="<?=$sessionData["session_start"]?>" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="datetime-local" class="form-control" name="session_end" style="text-transform: " value="<?=$sessionData["session_end"]?>" required>
    ...
    <script>
        ...
        $(".bfh-countries").bind("change",function () {
            $("form input[name=session_name]").attr("value",$(this).find(":selected").html());
        });

        $("#session_edit_form").on("submit",function (e) {
            e.preventDefault();

            if(!$("#session_edit_form").hasClass("not-valid")){

                $.ajax({
                    type: "POST",
                    url: "/inc/ajax/session-edit-post",
                    data: $("#session_edit_form").serializeArray(),
                    beforeSend:function () {
                        show_loading(button);
                    },
                    error:function () {
