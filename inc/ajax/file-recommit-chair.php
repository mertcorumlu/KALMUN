        ...
        <div class="row">
            ...
            <div class="col-md-12" style="padding:0;">
                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                    <h4 class="c-grey-900 mT-10 mB-30">Recommit File</h4>

                    <form id="file-commit-form" action="/inc/ajax/file-upload" method="POST" enctype="multipart/form-data"  class="needs-validation" >
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input id="fileupload" class="form-control border-0" type="file" accept=".doc,.docx,.pdf" name="file" >
                            ...
                            <input type="hidden" name="type" value="file_recommit">
        ...
        button.on("click",function () {
            $("form#file-commit-form").ajaxForm({
                ...
                success: function (data) {
                    ...
                    $("form").html("<div class=\"alert alert-success text-center\" >"+data.message+"<br><a href='/files'>List Files</a></div>");
