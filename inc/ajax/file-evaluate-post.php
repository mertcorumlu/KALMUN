...
try {
    ...
    $PDO->beginTransaction();
        ...
        if( post("type") =="file_evaluate" && is_authorized($auth->getCurrentUID(),array(0,1)) ){

            if( post("file_status") == "2" || post("file_status") == "4" ){
        ...
        ");
                ...
                $return = array(
                    "error" => false,
                    "message" => "File Status Succesfully Changed."
                );
